...
With these results, a sNPLS model was adjusted. The coefficients of the model are presented in \autoref{table:toxicity_results}.
...
\begin{tabular}{@{}lllll@{}}
\toprule
                                        & \multicolumn{1}{c}{\textbf{Time 1}} & \multicolumn{1}{c}{\textbf{Time 2}} & \textbf{Time 3} & \textbf{Time 4} \\ \midrule
\textbf{ROS}                            & \multicolumn{1}{c}{0.087}           & \multicolumn{1}{c}{0.087}           & 0.093           & 0.082           \\
\textbf{Calcium}                        & \multicolumn{1}{c}{0.094}           & \multicolumn{1}{c}{0.094}           & 0.101           & 0.089           \\
\textbf{MMP}                            & 0                                   & 0                                   & 0               & 0               \\
\textbf{Mitosox}                        & 0                                   & 0                                   & 0               & 0               \\
\textbf{GSH}                            & -0.048                              & -0.048                              & -0.051          & -0.045          \\
\textbf{Phospholipids}                  & 0.089                               & 0.089                               & 0.095           & 0.084           \\
\textbf{Lipids}                         & 0                                   & 0                                   & 0               & 0               \\
\textbf{Viability}                      & 0                                   & 0                                   & 0               & 0               \\
\textbf{ROS:concentration\_2}           & -0.032                              & -0.032                              & -0.032          & -0.031          \\
\textbf{ROS:concentration\_3}           & 0                                   & 0                                   & 0               & 0               \\
