...
\begin{tabular}{lcc}
\hline
                                  & \textbf{VIP score} \\ \hline
\textbf{ROS | 0.2Cmax}            & 0.78               \\
\textbf{Calcium | 0.2Cmax}        & 0.83               \\
\textbf{MMP | 0.2Cmax}            & 0.028              \\
\textbf{Mitosox | 0.2Cmax}        & 0.073              \\
\textbf{GSH | 0.2Cmax}            & 0.066              \\
\textbf{Phospholipids | 0.2Cmax}  & 0.31               \\
\textbf{Lipids | 0.2Cmax}         & 0.041              \\
\textbf{Viability | 0.2Cmax0.013} & 0.013              \\
\textbf{ROS | Cmax}               & 2.47               \\
\textbf{Calcium | Cmax}           & 1.92               \\
\textbf{MMP | Cmax}               & 0.033              \\
\textbf{Mitosox | Cmax}           & 0.21               \\
\textbf{GSH | Cmax}               & 0.13               \\
\textbf{Phospholipids | Cmax}     & 0.43               \\
\textbf{Lipids | Cmax}            & 0.27               \\
\textbf{Viability | Cmax}         & 0.13               \\
\textbf{ROS | 5Cmax}              & 5.09               \\
\textbf{Calcium | 5Cmax}          & 3.42               \\
\textbf{MMP | 5Cmax}              & 0.079              \\
\textbf{Mitosox | 5Cmax}          & 1.25               \\
\textbf{GSH | 5Cmax1.060}         & 0.47               \\
\textbf{Phospholipids | 5Cmax}    & 3.48               \\
\textbf{Lipids | 5Cmax}           & 1.97               \\
\textbf{Viability | 5Cmax}        & 0.50               \\ \hline
\end{tabular}}
\caption{VIP score values for the $N$-PLS model fitted to the toxicity data set.}
\label{table:VIP_toxi}
\end{table}
...
\begin{figure}[hbtp]
	\centering
\includegraphics[width=0.85\textwidth]{figura48.pdf}
